...
const InvoiceTemplate2 = (data: InvoiceTemplateProps) => {
    ...
    return (
        <InvoiceLayout data={data}>
                ...
                <div className="my-4">
                    ...
                    <div className="my-2">
                        <span className="font-semibold text-md text-gray-800">
                            ...
                            <p className="text-sm">
                                {t('bank', 'Bank:')} {details.paymentInformation?.bankName}
                            </p>
                            <p className="text-sm">
                                {t('accountName', 'Account name:')} {details.paymentInformation?.accountName}
                            </p>
                            <p className="text-sm">
                                {t('accountNumber', 'Account no:')} {details.paymentInformation?.accountNumber}
                            </p>
                        </span>
                    </div>
                </div>
            ...
            {details?.signature?.data && isDataUrl(details?.signature?.data) ? (
                ...
                <div className="mt-6">
                    <p className="text-gray-800">{t('signature', 'Signature')}</p>
                    <p
                        style={{
                            fontSize: 30,
                            fontWeight: 400,
